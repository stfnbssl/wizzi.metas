...
module.exports = {
    wfjobName: "wizzi-cli-meta/meta-templates/tfolder-ts-express",
    wfjobPath: path.join(__dirname, '.wizzi-override', 'meta-templates', 'tfolder-ts-express', 'generate.wfjob.ittf'), 
    plugins: [
