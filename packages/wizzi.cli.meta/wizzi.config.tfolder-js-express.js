...
module.exports = {
    wfjobName: "wizzi-cli-meta/meta-templates/tfolder-js-express",
    wfjobPath: path.join(__dirname, '.wizzi-override', 'meta-templates', 'tfolder-js-express', 'generate.wfjob.ittf'), 
    plugins: [
