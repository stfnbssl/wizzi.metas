/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.metas\packages\wizzi.meta.cloud\.wizzi-override\root\index.js.ittf
    utc time: Wed, 08 May 2024 04:39:25 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.cloud.index';
md.version = '0.0.2';
...
var pluginMetaProductions = [
    {
        name: 'cloudAzure', 
        title: 'cloudAzure wizzi meta production', 
        categories: [
            {
                name: 'cloud'
             }
    ...
    {
        name: 'cloudHeroku', 
        title: 'cloudHeroku wizzi meta production', 
        categories: [
            {
                name: 'cloud'
             }
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "cloud";
