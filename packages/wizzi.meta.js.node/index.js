/*
    ...
    utc time: Tue, 06 Feb 2024 10:14:18 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.js.node.index';
md.version = '';
...
var pluginMetaProductions = [
    {
        name: 'jsNodeScripts', 
        title: 'jsNodeScripts wizzi meta production', 
        categories: [
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "js.node";
