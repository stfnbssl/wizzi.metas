/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.metas\packages\wizzi.meta.js.vanilla\.wizzi-override\root\index.js.ittf
    utc time: Mon, 19 Feb 2024 15:47:55 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.js.vanilla.index';
md.version = '0.0.2';
...
var pluginCategories = [
    {
        ...
        productions: [
            {
                name: "jsVanillaWebpackGetStartedApp"
             }, 
            {
                name: "jsVanillaUtils"
             }
...
var pluginMetaProductions = [
    {
        name: 'jsVanillaWebpackGetStartedApp', 
        title: 'jsVanillaWebpackGetStartedApp wizzi meta production', 
        categories: [
            {
                name: 'javascript'
             }, 
    ...
    {
        name: 'jsVanillaUtils', 
        title: 'jsVanillaUtils wizzi meta production', 
        categories: [
            {
                name: 'javascript'
             }, 
...
class FactoryMeta {
    constructor(provides) {
        this.name = "wizzi.meta.js.vanilla";
        this.version = "0.0.2";
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "js.vanilla";
