/*
    ...
    utc time: Fri, 16 Feb 2024 08:58:46 GMT
*/
'use strict';
...
var pluginMetaProductions = [
    {
        name: 'wizziJobs', 
        title: 'wizziJobs wizzi meta production', 
        categories: [
    ...
    {
        name: 'wizziFactory', 
        title: 'wizziFactory wizzi meta production', 
        categories: [
    ...
    {
        name: 'wizziPlugin', 
        title: 'wizziPlugin wizzi meta production', 
        isPackageMain: true, 
        categories: [
    ...
    {
        name: 'wizziMeta', 
        title: 'wizziMeta wizzi meta production', 
        isPackageMain: true, 
        categories: [
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "wizzi";
