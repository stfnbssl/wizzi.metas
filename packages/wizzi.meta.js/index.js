/*
    ...
    utc time: Wed, 08 May 2024 04:39:33 GMT
*/
'use strict';
...
var pluginMetaProductions = [
    {
        name: 'jsCLI', 
        title: 'jsCLI wizzi meta production', 
        isPackageMain: true, 
        categories: [
            {
                name: 'javascript'
    ...
    {
        name: 'jsCommons', 
        title: 'jsCommons wizzi meta production', 
        categories: [
            {
                name: 'javascript'
             }
    ...
    {
        name: 'jsUtils', 
        title: 'jsUtils wizzi meta production', 
        categories: [
            {
                name: 'javascript'
             }, 
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "js";
