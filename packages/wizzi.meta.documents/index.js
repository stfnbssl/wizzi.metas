/*
    ...
    utc time: Wed, 08 May 2024 04:39:31 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.documents.index';
md.version = '0.0.2';
...
class FactoryMeta {
    constructor(provides) {
        this.name = "wizzi.meta.documents";
        this.version = "0.0.2";
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "documents";
