/*
    ...
    utc time: Mon, 19 Feb 2024 15:44:56 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.ts.nextjs.index';
md.version = '0.0.2';
...
var pluginMetaProductions = [
    ...
    {
        name: 'tsNextjsBlog', 
        title: 'tsNextjsBlog wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
...
class FactoryMeta {
    constructor(provides) {
        this.name = "wizzi.meta.ts.nextjs";
        this.version = "0.0.2";
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "ts.nextjs";
