/*
    ...
    utc time: Fri, 16 Feb 2024 08:22:54 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.ts.db.index';
md.version = '';
...
var pluginMetaProductions = [
    {
        name: 'tsDbMongoDb', 
        title: 'tsDbMongoDb wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
    ...
    {
        name: 'tsDbPostgres', 
        title: 'tsDbPostgres wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
    ...
    {
        name: 'tsDbRedis', 
        title: 'tsDbRedis wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
    ...
    {
        name: 'tsDbSequelize', 
        title: 'tsDbSequelize wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "ts.db";
