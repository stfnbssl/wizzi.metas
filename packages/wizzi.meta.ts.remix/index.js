/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.metas\packages\wizzi.meta.ts.remix\.wizzi-override\root\index.js.ittf
    utc time: Fri, 26 Apr 2024 12:14:23 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.ts.remix.index';
md.version = '';
...
var pluginMetaProductions = [
    {
        name: 'tsRemix', 
        title: 'tsRemix wizzi meta production', 
        categories: [
            {
                name: 'typescript'
             }, 
    ...
    {
        name: 'tsRemixApp', 
        title: 'tsRemixApp wizzi meta production', 
        isPackageMain: true, 
        categories: [
            {
                name: 'typescript'
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "ts.remix";
