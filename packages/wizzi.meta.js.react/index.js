/*
    ...
    utc time: Tue, 06 Feb 2024 10:14:20 GMT
*/
'use strict';
...
md.name = 'wizzi.meta.js.react.index';
md.version = '0.0.2';
...
var pluginMetaProductions = [
    {
        name: 'jsReact', 
        title: 'jsReact wizzi meta production', 
        categories: [
    ...
    {
        name: 'jsReactApp', 
        title: 'jsReactApp wizzi meta production', 
        isPackageMain: true, 
        categories: [
    ...
    {
        name: 'jsReactWebpackGetStartedApp', 
        title: 'jsReactWebpackGetStartedApp wizzi meta production', 
        categories: [
    ...
    {
        name: 'jsReactUtils', 
        title: 'jsReactUtils wizzi meta production', 
        categories: [
    ...
    */
    getMetaProduction(productionName, callback) {
        ...
        return this.getFolderTemplates(productionName, metaProduction, (err, notUsed) => {
                ...
                metaProduction.metaNamespace = "js.react";
